...
public class OrcamentoPrestadorAdapter extends BaseAdapter {

    private List<Orcamento> orcamentoList;
    private LayoutInflater inflater;

    public OrcamentoPrestadorAdapter(Context context, List<Orcamento> orcamentoList) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.item_adapter_orcamento_prestador, null);
            view.setTag(holder);
