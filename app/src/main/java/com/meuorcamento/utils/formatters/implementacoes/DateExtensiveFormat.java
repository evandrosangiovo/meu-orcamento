...
public class DateExtensiveFormat extends Formatter {

    SimpleDateFormat simpleDateFormat;
    public DateExtensiveFormat(Object value) {
        super(value);
        simpleDateFormat = new SimpleDateFormat("EEEE, d MMMM yyyy HH:mm:ss");
